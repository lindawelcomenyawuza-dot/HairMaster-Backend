...
export const resolvers = {
  ...
  createPost: async (args, { req }) => {
    ...
    const post = new Post({
      ...
      barberName: salonStaff?.stylist.fullName || args.barberName,
      ...
      stylistName: salonStaff?.stylist.fullName || args.barberName,
      stylistAvatar: salonStaff?.stylist.profileImageKey || salonStaff?.stylist.profileImage || '',
      stylistRole: salonStaff?.stylist.role || '',
      stylistBio: salonStaff?.stylist.bio || '',
  ...
  repost: async ({ originalPostId }, { req }) => {
    ...
    const repost = new Post({
      ...
      stylistRole: original.stylistRole,
      stylistBio: original.stylistBio,
